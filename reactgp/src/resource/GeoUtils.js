...
(function() { 
    ...
    GeoUtils.isPointInRect = function(point, bounds){
        //检查类型是否正确
        if (!(point instanceof window.BMap.Point) || 
            !(bounds instanceof window.BMap.Bounds)) {
            return false;
        }
    ...
    GeoUtils.isPointInCircle = function(point, circle){
        ...
        //检查类型是否正确
        if (!(point instanceof window.BMap.Point) || 
            !(circle instanceof window.BMap.Circle)) {
            return false;
        }
    ...
    GeoUtils.isPointOnPolyline = function(point, polyline){
        //检查类型
        if(!(point instanceof window.BMap.Point) ||
            !(polyline instanceof window.BMap.Polyline)){
            return false;
        }
...
GeoUtils.isPointInPolygon = function(point, polygon){
    ...
    //检查类型
    if(!(point instanceof window.BMap.Point) ||
        !(polygon instanceof window.BMap.Polygon)){
...
GeoUtils.getDistance = function(point1, point2){
    //判断类型
    if(!(point1 instanceof window.BMap.Point) ||
        !(point2 instanceof window.BMap.Point)){
        return 0;
    }
...
GeoUtils.getPolylineDistance = function(polyline){
    //检查类型
    if(polyline instanceof window.BMap.Polyline || 
...
GeoUtils.getPolygonArea = function(polygon){
    //检查类型
    if(!(polygon instanceof window.BMap.Polygon) &&
